...
Partial Class SynoC5
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(SynoC5))
        Button1 = New Button()
        Label1 = New Label()
        Label2 = New Label()
        Label3 = New Label()
        ...
        ' Button1
        ' 
        Button1.Location = New Point(4, 18)
        ...
        Label1.TabIndex = 1
        Label1.Text = "The Twelve Kingdoms"
        ' 
        ' Label2
        ' 
