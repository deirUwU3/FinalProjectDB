...
Partial Class SynoD4
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(SynoD4))
        Button1 = New Button()
        Label1 = New Label()
        Label2 = New Label()
        Label3 = New Label()
        ...
        Label1.TabIndex = 1
        Label1.Text = "The Story of Saiunkoku"
        ' 
        ' Label2
        ' 
